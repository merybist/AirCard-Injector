...
* **[@jkcoxson](https://github.com/jkcoxson)** — Creator of **[idevice_pair](https://github.com/jkcoxson/idevice_pair)** and the `idevice` Rust ecosystem enabling RemotePairing and pairing setup on iOS.
